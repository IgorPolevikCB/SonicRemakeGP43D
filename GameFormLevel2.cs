...
{
    public partial class GameFormLevel2 : Form
    {
        ...
        public GameFormLevel2 ()
        {

        }

        public GameFormLevel2(MainMenu menu)
        {
            InitializeComponent();
